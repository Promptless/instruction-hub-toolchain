...
commit_user_name="${INPUT_COMMIT_USER_NAME:-promptless-instruction-hub-action[bot]}"
commit_user_email="${INPUT_COMMIT_USER_EMAIL:-197982258+promptless-instruction-hub-action[bot]@users.noreply.github.com}"
